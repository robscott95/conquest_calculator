...
def show():
    ...
    def special_ability_input(key, label, value, input_type='number'):
        """Create an input widget based on the type and update session state."""
        current_value = st.session_state.special_abilities_values[key]['value']
        # Create widget and get new value
        ...
        # Update modified state and value if changed
    ...
    # Calculation and display area outside of form context, responsive to input changes
